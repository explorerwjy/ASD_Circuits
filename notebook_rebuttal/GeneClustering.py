...
# Load mutation data
ASD_Discov_Muts = pd.read_csv("/mnt/data0/home_backup/Work/ASD_Circuits/dat/genes/SPARK/ASD_Discov_DNVs.txt", delimiter="\t")
ASD_Rep_Muts = pd.read_csv("/mnt/data0/home_backup/Work/ASD_Circuits/dat/genes/SPARK/ASD_Rep_DNVs.txt", delimiter="\t")
ASD_Muts = pd.concat([ASD_Discov_Muts, ASD_Rep_Muts])

# Filter to high-confidence genes
Spark_Meta_2stage = pd.read_excel("/mnt/data0/home_backup/Work/ASD_Circuits/dat/genes/asd/TabS_DenovoWEST_Stage1+2.xlsx",
